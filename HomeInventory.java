...
{ 
	...
	JButton previousButton = new JButton(new ImageIcon("gif"));
	...
	int currentEntry; static final int entriesPerPage = 2;
	static int lastPage;
...
{ 
	...
	public void paintComponent(Graphics g)
	{
		...
		// center in panel 
		g2D.drawImage(photoImage, (int) (0.5 * (getWidth() - w)), (int) (0.5 * (getHeight() )), w, h, null);
		g2D.dispose();
		}
		}
...
//            y += dy;
	   ...
	   try 
	   {
						 // maintain original width/height rat
